...
module rvfi_insn_c_srli (
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] insn_shamt = {rvfi_insn[12], rvfi_insn[6:2]};
  ...
  assign spec_valid = rvfi_valid && insn_funct3 == 3'b 100 && insn_funct2 == 2'b 00 && insn_opcode == 2'b 01 && insn_shamt && !insn_shamt[5];
