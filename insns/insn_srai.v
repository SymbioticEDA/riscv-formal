...
module rvfi_insn_srai (
  ...
  wire [4:0] insn_shamt  = rvfi_insn[24:20];
  ...
  // SRAI instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = $signed(rvfi_pre_rs1) >>> insn_shamt;
  assign spec_valid = rvfi_valid && insn_funct7 == 7'b 0100000 && insn_funct3 == 3'b 101 && insn_opcode == 7'b 0010011;
