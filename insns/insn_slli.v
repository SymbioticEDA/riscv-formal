...
module rvfi_insn_slli (
  ...
  // SLLI instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = rvfi_pre_rs1 << insn_shamt;
  assign spec_valid = rvfi_valid && insn_funct7 == 7'b 0000000 && insn_funct3 == 3'b 001 && insn_opcode == 7'b 0010011;
